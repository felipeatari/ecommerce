<div class="w-full flex flex-col justify-center px-3">
    <form wire:submit.prevent="update" class="bg-white w-full px-10 py-5 shadow">
        <div class="w-full flex justify-between my-5">
            ...
            <button type="button" class="bg-gray-900 hover:bg-gray-700 text-white px-3 py-1" wire:click="update">Salvar</button>
        </div>

        <h1 class="font-bold my-10">Editar Sku {{ $sku->id }}</h1>
        ...
        <div class="w-full flex my-10">
            <div class="w-full flex">
                ...
                @foreach ($products as $product)
                    ...
                    <div class="w-full border px-2 py-1">{{ $product->name }}</div>
                    @endif
                @endforeach
            </div>
    ...
    <form wire:submit.prevent="updateImage" class="bg-white w-full px-10 pb-5 mt-3 shadow">
        <h1 class="font-semibold mt-5">Editar imagens:</h1>
        <div class="w-full flex justify-between my-5">
        ...
        <button type="button" class="bg-gray-900 hover:bg-gray-700 text-white px-3 py-1" wire:click="updateImage">Salvar</button>
    </form>
</div>
